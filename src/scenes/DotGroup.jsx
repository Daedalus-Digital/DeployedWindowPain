...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
	const selectedStyles = `relative bg-ribcolororange before:absolute before:w-6 before:h-6
    before:rounded-full before:border-2 before:border-dark-grey before:left-[-50%] before:top-[-50%]`;
