  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      <div className="md:flex md:justify-between gap-8">
        <motion.div
          className="mx-auto relative bg-ribcolororange max-w-[400px] h-[350px] flex flex-col justify-end p-16 mt-48
        ...
        <motion.div
          className="mx-auto relative bg-sunyellow max-w-[400px] h-[350px] flex flex-col justify-end p-16 mt-48
        ...
        <motion.div
          className="mx-auto relative bg-[#fdd474] max-w-[400px] h-[350px] flex flex-col justify-end p-16 mt-48
